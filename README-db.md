...
With a spatial database, we can find the number of those households within a half-mile of a [http://www.cityofchicago.org/city/en/depts/cdph/provdrs/clinic/svcs/apply_for_wic.html](WIC) Office:
